...
async function execute() {
  ...
  const encNote1 = await encrypt(
    '9e8f633D0C46ED7170EF3B30E291c64a91a49C7E',
    '9',
  );
  const encNote2 = await encrypt(
    '3644B986B3F5Ba3cb8D5627A22465942f8E06d09',
    '2',
  );
  // console.log(..._proof, encNote1, encNote2)
  console.log(
    'calling transferNote with params',
    ..._proof,
    encNote1,
    encNote2,
  );
  ...
  try {
    await secretNoteContract.methods
      .transferNote(..._proof, encNote1, encNote2)
      .send({
